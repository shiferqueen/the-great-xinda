<template>
  <div>
    <myhead></myhead>
   <div><p class="head_top">首页/财税服务</p></div>
   <!--------------------商品部分------------------------------>
   <div class="goods-main">
       ...
       <div class="goods-middle">  
            ...
            <div class="bg">
                <p class="bg-p">市场价：<span class="huadiao">￥900.00 </span></p>
                <p class="bg-p">价格<span class="price">￥800.00</span>元</p>
            </div>
            <p>类型：<span class="kuang">注册分公司</span></p>
            <p>地区：北京-北京市-朝阳区</p>
            <p>购买数量：<button>-</button><input type="text" placeholder="1"><button>+</button></p>
            <div class="summbit">
                <span>立即购买</span>
                <span>加入购物车</span>
            </div>
       ...
       <div class="main-con2" v-show="con2">
           <div class="main-con2-top">
                ...
                <div class="main-con2-middle">
                    <p>好评（<span>0%</span>）<span class="tiao"></span></p>
                    <p>中评（<span>0%</span>）<span class="tiao"></span></p>
                    <p>差评（<span>0%</span>）<span class="tiao"></span></p>
                </div>
             ...
             <div class="main-con2-nav">
                <span>全部评价（0）</span><span>好评</span><span>中评</span><span>差评</span>
             </div>
