        ...
        <div class="content">
          ...
          <div class="con-main" v-for="(listeach,index) in listpage_ajax" >
            ...
            <div class="con-main-middle">
              <h4><a href="#/products">{{listeach.serviceName}}</a></h4>
...
export default {
  ...
  created(){
    let _this = this
   this.ajax.post("/xinda-api/product/package/grid",qs.stringify({start:0,limit:8,productTypeCode: "1",
   productId: "8a82f52b674543e298d2e5f685946e6e",sort:2})).then(function(res){
